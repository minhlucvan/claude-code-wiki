...
| 功能 | Claude Code | Cursor | Continue | Aider |
|------|-------------|--------|----------|-------|
| **流式工具执行** | ✅ 并发 | ❌ 顺序 | ❌ 顺序 | ❌ 顺序 |
| **上下文管理** | ✅ 5层自动压缩 | ⚠️ 基本截断 | ⚠️ 基本截断 | ⚠️ 手动 |
| **多代理** | ✅ 原生缓存共享 | ❌ 无 | ❌ 无 | ⚠️ 有限 |
| **安全** | ✅ AST解析+权限 | ⚠️ 基本提示 | ⚠️ 基本提示 | ⚠️ 用户批准 |
| **终端 UI** | ✅ React/Ink（丰富） | N/A (IDE) | N/A (IDE) | ⚠️ 基本CLI |
| **MCP 支持** | ✅ 客户端+服务器 | ⚠️ 仅客户端 | ⚠️ 仅客户端 | ❌ 无 |
| **提示缓存** | ✅ 分叉优化 | ⚠️ 基本 | ⚠️ 基本 | ❌ 无 |
