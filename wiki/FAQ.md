...
See [Competitive Advantages](01-competitive-advantages) for detailed comparison with Cursor, Continue, and Aider.
...
See [Architecture Overview](02-architecture-overview) for complete system design.
...
See [Terminal UX](06-terminal-ux) for component architecture.
...
See [Architecture Overview](02-architecture-overview#technology-stack) for details.
...
See [Streaming Execution](03-streaming-execution) for complete implementation.
...
See [Streaming Execution](03-streaming-execution#2-concurrent-executor) for safety checks.
...
See [Streaming Execution](03-streaming-execution#error-recovery) for implementation.
...
See [Context Management](04-context-management#2-compaction-trigger) for code.
...
See [Context Management](04-context-management#semantic-preservation) for prompt engineering.
...
See [Context Management](04-context-management#token-economics) for breakdown.
...
See [Multi-Agent Orchestration](05-multi-agent-orchestration#1-agent-definition) for definitions.
...
See [Multi-Agent Orchestration](05-multi-agent-orchestration#3-cache-fork-pattern) for economics.
...
See [Multi-Agent Orchestration](05-multi-agent-orchestration#4-coordinator-mode) for patterns.
...
See [Terminal UX](06-terminal-ux#2-component-architecture) for details.
...
See [Terminal UX](06-terminal-ux#5-tool-rendering-system) for rendering system.
...
See [Terminal UX](06-terminal-ux#4-command-palette) for implementation.
...
See [Security Model](07-security-model#1-ast-level-bash-parsing) for parser.
...
See [Security Model](07-security-model#4-permission-modes) for implementation.
...
See [Security Model](07-security-model#3-risk-assessment) for heuristics.
...
See [Integration Ecosystem](08-integration-ecosystem#1-dual-role-mcp) for architecture.
...
See [Integration Ecosystem](08-integration-ecosystem#3-skill-system) for examples.
...
See [Integration Ecosystem](08-integration-ecosystem#2-ide-bridges) for protocol.
...
See [Production Engineering](09-production-engineering#1-startup-optimization) for patterns.
...
See [Production Engineering](09-production-engineering#2-feature-flag-optimization) for implementation.
...
See [Production Engineering](09-production-engineering#3-prompt-cache-economics) for analysis.
...
See [Architecture Overview](02-architecture-overview#3-tool-system) for tool categories.
...
See [Architecture Overview](02-architecture-overview#3-immutability) for principles.
...
See [Production Engineering](09-production-engineering#4-error-handling) for patterns.
...
See [Streaming Execution](03-streaming-execution#implementation-challenges) for details.
...
See [Context Management](04-context-management#3-compaction-algorithm) for full algorithm.
...
See [Production Engineering](09-production-engineering#fleet-scale-optimization) for patterns.
...
See [Lessons Learned](10-lessons-learned) for complete insights.
...
- [01. Competitive Advantages](01-competitive-advantages) - The 10 architectural innovations
- [02. Architecture Overview](02-architecture-overview) - System design and data flow
- [03. Streaming Execution](03-streaming-execution) - Real-time tool execution
- [04. Context Management](04-context-management) - 5-layer autocompaction
- [05. Multi-Agent Orchestration](05-multi-agent-orchestration) - Multi-agent workflows
- [06. Terminal UX](06-terminal-ux) - React terminal UI
- [07. Security Model](07-security-model) - AST parsing and permissions
- [08. Integration Ecosystem](08-integration-ecosystem) - MCP, IDE bridges, skills
- [09. Production Engineering](09-production-engineering) - Optimization patterns
- [10. Lessons Learned](10-lessons-learned) - Key takeaways
...
- 📚 Read the [complete technical documentation](Home)
- 🔍 Explore the [codebase patterns](10-lessons-learned)
- 🏗️ Apply these [architectural principles](09-production-engineering) to your own tools
- 💡 Study the [competitive analysis](01-competitive-advantages) for positioning insights
